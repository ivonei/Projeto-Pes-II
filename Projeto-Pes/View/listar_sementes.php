...
$resultado = mysqli_query($conectar, "SELECT * FROM sementes WHERE id_user = '$id_user' ");
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Sementes</h2>
          <div class="table-responsive">
		   ...
		   ?>			 
			<td>
			   <a href='visual_sementes.php?id=<?php echo $linhas['id']; ?>'><button type='button' class='btn btn-primary'>Visualizar</button></a>			
			   <a href='editar_sementes.php?id=<?php echo $linhas['id']; ?>'><button type='button' class='btn btn-warning'>Editar</button></a>
			   <a href='../Controller/process_remove_sementes.php?id=<?php echo $linhas['id']; ?>'><button type='button' class='btn btn-danger'>Remover</button></a>
			  <?php
			  echo "<tr>";
			}
		?>

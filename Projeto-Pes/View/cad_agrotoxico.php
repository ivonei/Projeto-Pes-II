...
<html lang="pt-br">
   ...
   <body>
      ...
      <div class="page-header">
         <br></br>
         <h1>Cadastrar de Agrotoxico</h1>
      </div>
      <div class="row">
      <div class="col-md-12">
         <form class="form-horizontal" method="POST" action="../Controller/process_cad_agrotoxico.php">
            <div class="form-group">
               <label for="inputEmail3" class="col-sm-2 control-label">Nome</label>
               <div class="col-sm-10">
                  <input type="text" class="form-control" name="nome"  placeholder="Nome dd agrotoxico">
               </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               <label for="inputPassword3" class="col-sm-2 control-label">Tipos de Agrotoxico</label>
               <div class="col-sm-10">
                  <select class="form-control" name="categoria_id">
                     <?php
                        // $resultado = mysqli_query($conectar, "SELECT * FROM categoriasementes ORDER BY 'id'");
                        // $linhas=mysqli_num_rows($resultado);
                        $resultado=mysqli_query($conectar,"SELECT * FROM categoriaagrotoxico");

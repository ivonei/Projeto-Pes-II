...
$id = $_GET['id'];
$result = mysqli_query( $conectar, "SELECT * FROM agrotoxico WHERE id = '$id' LIMIT 1");
...
<nav class="navbar navbar-inverse navbar-fixed-top">
 ...
 <div class="container theme-showcase" role="main">
  ...
  <div class="row">
	<div class="col-md-12">
				  <form class="form-horizontal" method="POST" action="../Controller/process_edita_agrotoxico.php">
			   ...
			   <div class="form-group">
				...
				<div class="col-sm-10">
                     ...
                     // $linhas=mysqli_num_rows($resultado);
									$result=mysqli_query($conectar,"SELECT * FROM categoriaagrotoxico");

      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
			...
			<li><a href="../Mode/sair.php">Sair</a></li>
          </ul>
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              ...
              <h4> Sementes</h4>
			   ...
			   <br><a href='listar_sementes'><button type='button' class='btn btn-primary'>Listar</button></a></br>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="../Imagem/Agrotoxico.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Agrotóxico</h4>
			   <br><a href='cad_agrotoxico.php'><button type='button' class='btn btn-success'>Cadastrar</button></a></br>
			   <br><a href='listar_agrotoxico.php'><button type='button' class='btn btn-primary'>Listar</button></a></br>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">

    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              ...
              <h4> Sementes</h4>
			   ...
			   <br><a href='#'><button type='button' class='btn btn-primary'>Visualizar</button></a></br>
               <br><a href='#'><button type='button' class='btn btn-warning'>Editar </button></a></br>
			   <br><a href='#'><button type='button' class='btn btn-danger'>Remover</button></a></br>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
          ...
          <h2 class="sub-header">Tabela de Dados</h2>
